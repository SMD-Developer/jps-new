...
class ExpenseDatatable extends CoreDatatable
{
    ...
    protected string $deleteRoute = 'expenses.destroy';
    public function __construct() 
    {
        parent::__construct();
        $this->show_permission = hasPermission('expense.view');
        $this->edit_permission = hasPermission('expense.edit');
        $this->delete_permission = hasPermission('expense.delete');
    }
    public function dataTable($query){
        ...
        $dataTable->editColumn('amount',function($row){
            return format_amount($row->amount,$row->currency);
        });   
        return $dataTable;
    }
