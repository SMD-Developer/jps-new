...
class CurrencyDatatable extends CoreDatatable
{
    ...
    protected string $deleteRoute = 'settings.currency.destroy';
    public function __construct() 
    {
        parent::__construct();
        $this->show_permission = hasPermission('currency.view');
        $this->edit_permission = hasPermission('currency.edit');
        $this->delete_permission = hasPermission('currency.delete');
    }
        ...
        $builder->columns($this->getColumns())
            ...
            ->parameters([
                ...
                'buttons' => [
                    ...
                    ['extend' => 'pageLength', 'className' => 'btn-sm btn-secondary'],
                ],
                'regexp'  => true
            ]);
