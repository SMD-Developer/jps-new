...
class PaymentMethodDatatable extends CoreDatatable
{
    ...
    protected string $deleteRoute = 'settings.payment.destroy';
    public function __construct() 
    {
        parent::__construct();
        $this->show_permission = hasPermission('payment-method.view');
        $this->edit_permission = hasPermission('payment-method.edit');
        $this->delete_permission = hasPermission('payment-method.delete');
    }
