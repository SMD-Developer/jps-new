...
class PermissionDatatable extends CoreDatatable
{
    ...
    protected string $deleteRoute = 'settings.permission.destroy';
    public function __construct() 
    {
        parent::__construct();
        $this->show_permission = hasPermission('permission.view');
        $this->edit_permission = hasPermission('permission.edit');
        $this->delete_permission = hasPermission('permission.delete');
    }
