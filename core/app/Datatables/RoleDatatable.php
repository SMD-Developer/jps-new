...
class RoleDatatable extends CoreDatatable
{
    ...
    protected string $deleteRoute = 'settings.role.destroy';
    protected string $permissionRoute = 'settings.role.show';
    public function __construct() 
    {
        parent::__construct();
        $this->show_permission = hasPermission('role.view');
        $this->edit_permission = hasPermission('role.edit');
        $this->delete_permission = hasPermission('role.delete');
        $this->assign_permission = hasPermission('permission.assign');
    }
