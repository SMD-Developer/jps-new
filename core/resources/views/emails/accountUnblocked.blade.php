...
<body>
    <table>
        ...
        <tr>
            <td class="content">
                <p>Sayang,</p>
                <p>Great news! Your account has been unblocked by an administrator.</p>
                <p>You can now log in to your account normally and continue using our services.</p>
                <p>If you have any questions or concerns about your account status, please don't hesitate to contact our
                    support team.</p>
                <div style="text-align: center;">
                    <a href="{{ url('/clientarea/login') }}" class="button">Log In to Your Account</a>
                </div>
            </td>
        </tr>
        <tr>
