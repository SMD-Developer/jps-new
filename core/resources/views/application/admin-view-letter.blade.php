        ...
        <div class="container middle-body">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <!--<p><b>Selangor</b></p>-->
                    <!--<p class="ml-5">Ini adalah cetakan komputer dan tidak perlu ditandatangani</p>-->
                </div>
                <div class="col-md-2"></div>
            </div>
            <div class="row last_row align-items-center mt-3">
                <div class="col-md-6">
                    <p class="last_para mb-0" style="margin-left: 166px; white-space: nowrap; color: grey;">@lang('app.computer_printout')</p>
                </div>
            </div>
           <div class="container">
                <div class="row print-button-row">
                    <div class="col-md-12 mb-2 no-print" style="display:flex; justify-content:end;">
                        ...
                        <button type="button" class="btn btn-success mx-2"  onclick="window.location.href='{{ route('application_status') }}'">
                        @lang('app.back')
                    </button>
                    </div>
                </div>
