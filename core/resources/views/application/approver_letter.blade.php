        ...
        <div class="container middle-body">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <br>
                    <p class="">Tuan,</p>
                    <h6 class="mb-0 text-justify"><b>PENGESAHAN BAYARAN CARUMAN PARIT DI {{$application->land_lot}}, {{ strtoupper($application->land_mukim ?? 'N/A') }}, DAERAH {{ strtoupper($application->land_daerah ?? 'N/A') }}, NEGERI SELANGOR UNTUK TETUAN {{strtoupper($application->applicant)}}.</b></h6>
                ...
                <div class="col-12 col-md-6 d-flex align-items-center">
                    <!-- LEFT column (text) -->
                    <p class="last_para mb-0" style="margin-left:152px; white-space: nowrap; color: grey; margin-top:10px;">
            ...
            <div class="row last_row align-items-center mt-5" style="justify-content: end;">
                <div class="col-12 col-md-6 d-flex justify-content-md-end mt-3 mt-md-0">
                    <button type="button" class="btn btn-success mx-2 no-print" onclick="window.location.href='{{ route('application_status') }}'">
                        @lang('app.back')
                    </button>
                    @if($application->status == 'approved')
                       <button type="button" class="btn btn-secondary btn3 no-print" onclick="window.print()">
