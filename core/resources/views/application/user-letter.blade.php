            ...
            <div class="row font-print">
                ...
                <div class="col-md-10 font-print">
                    ...
                    <p class="font-print" style="text-align:justify;">
                        ...
                        <?php
                            if($application->land_unit == '1'){
                                $hectare = number_format($application->land_area/10000, 2);
                            }else{
                                $hectare = number_format($application->hectare, 2);
                            }
                        ?>
                        ...
                        @else
                            ...
                            ialah <b>{{ $hectare }} hektar</b>. Oleh yang demikian pihak tuan adalah
                            dikehendaki membayar caruman parit ke jabatan ini <b>berjumlah RM
                                ...
                                @if($application->appeal != 'yes')
                                    (RM {{ number_format($application->cost, 2) }} x {{ $hectare }} hektar)
                                @endif
                            </b>.
                            <br><br>
