    ...
    <section class="content">
        ...
        <div class="container middle-body">
            ...
            <div class="row last_row">
                <div class="col-md-2"></div>
                    <div class="col-md-8">
                    <p class="last_para mb-5">@lang('app.computer_printout')</p>
                    <label>@lang('app.upload_bank_receipt'): </label>
            ...
            <div class="row last_row">
                ...
                <div class="col-6 float-right mt-5 col6">
                        ...
                        <a href="javascript:void(0);" type="button" class="btn btn-danger float-right" id="uploadPdfButton">
                            @lang('app.please_upload_payment')
                        </a>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.getElementById("uploadPdfButton").addEventListener("click", function() {
            Swal.fire({
                title: "{{ __('app.your_details_submitted_successfully') }}",
                // text: "Your PDF has been uploaded successfully!",
                icon: "success",
                confirmButtonText: "OK"
            }).then(() => {
                window.location.href = "{{ route('original_receipts') }}"; // Redirect after OK
            });
        });
    });
</script>