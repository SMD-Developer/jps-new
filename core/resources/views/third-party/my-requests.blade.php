                                ...
                                @forelse($requests as $index => $request)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                {{-- Not downloaded yet --}}
                                                <form method="POST" action="{{ route('third.party.download.receipt', $request->id) }}" style="display: inline;">
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm btn-success download-btn" style="white-space: nowrap;">
...
$(document).ready(function() {
    $('form').on('submit', function(e) {
        var button = $(this).find('.download-btn');
