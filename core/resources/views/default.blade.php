...
button.btn.btn-primary.login-button.btn-sm.btn-block.disabled {
    background: #2c2cb7;
    border-radius: 15px;
    border: 2px solid #cecece;
    padding: 5px 0px 9px 0px;
}
button.btn.btn-primary.login-button.btn-sm.btn-block {
    background: #2c2cb7;
    border-radius: 15px;
    border: 2px solid #cecece;
    padding: 5px 0px 9px 0px;
...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
    ...
    <div class="container-fluid ps-0 mt-5">
        ...
        <div class="row mt-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 col-12 icon-text2 pt-4 pb-0 mb-0 mt-3">
                    <!--<p class="text-center text-light"><b>Log Masuk</b></p>-->
                    {!! Form::open(['url' => '/login','class'=>'loginFrm needs-validation mt-3','novalidate']) !!}
                    <div class="input-box email">
                        <!--<input type="email" id="email-input" required placeholder="Emel">-->
                        <!--{!! Form::label('email', trans('app.email_or_username')) !!}-->
                        {!! Form::input('text','login', null, ['class'  =>"form-control", 'required'=>'required', 'placeholder'=>"Emel"]) !!}
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="filterSearchForm"  class="filterform">
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-md-3">
                        <label for="city" class="col-md-3 col-form-label">@lang('app.city'):</label>
                        </div>
                        <div class="col-md-9">
...
<div class="modal fade" id="feedbackModal" tabindex="-1" aria-labelledby="feedbackModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <form id="filterSearchForm"  class="filterform">
                            ...
                            <div class="row align-items-center mb-3"  style="white-space: nowrap;">
                                <div class="col-md-3">
                                    <label for="username" class="col-md-3 col-form-label">@lang('app.telephone_no'):<span class="important">*</span></label>
                                </div>    
                                <div class="col-md-9">
    ...
    @php
    $bg = get_setting_value('login_bg') != '' ? image_url(get_setting_value('login_bg')) : image_url('JPS logo.jpg');
    @endphp
    
    <script src="https://www.google.com/recaptcha/api.js" async defer></script>
    <script>$.backstretch("{{$bg}}");</script>
