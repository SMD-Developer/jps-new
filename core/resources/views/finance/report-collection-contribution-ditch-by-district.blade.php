    ...
    <section>
        <div class="report-container">
                            ...
                            <div class="report-header">
                                <div class="header-row">
                                    ...
                                    <div class="main-title">
                                        ...
                                        <p><strong>
                                            LAPORAN KUTIPAN CARUMAN PARIT MENGIKUT DAERAH PADA 
                                            {{ \Carbon\Carbon::parse($startDate)->format('d/m/Y') }}
                                            HINGGA {{ \Carbon\Carbon::parse($endDate)->format('d/m/Y') }}
                                        </strong></p>
                                            @if ($isFilteredByDistrict && $selectedDistrictName)
                                                   <h2><strong>DAERAH: {{ strtoupper($selectedDistrictName) }}</strong></h2>
                                               @else
                                                   <h2><strong>DAERAH: SEMUA DAERAH</strong></h2>
                                             @endif
                                    </div>
                                    <div class="page-info">
            ...
            <div class="action-section" id="btn-section">
                <button class="btn-prints" onclick="window.location.href='{{ route('report-collection-contribution-ditch-by-district-search') }}'">
                    Kembali
                </button>
