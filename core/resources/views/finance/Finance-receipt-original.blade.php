    ...
    <div class="container">
            ...
            <div class="col-md-12">
               ...
               <div class="row">
                   <div class="col-12 row1" style="padding-right: 100px;">
                       <img src="{{ asset('assets/images/uploads/settings/logo.png') }}" class="img " alt="..."     width="190px">
                   </div>
               </div>
               <div class="row">
                   <div class="col-2"></div>
                   <div class="col-6 px-0 text-center">
                        ...
                        <p class="mb-0 text-center">Resit Rasmi</p>
                   ...
                   <div class="col-12">
                              ...
                              <tr class="">
                                <td class="py-4" >
                                   <div class="row" style="font-weight: 600;">
                                        ...
                                        <div class="col-3  text-right px-3 " style="word-wrap: break-word;overflow: hidden;text-overflow: ellipsis;
                                            max-width: 100%;
                                            display: block;
                                            /* white-space: nowrap; */
                                            ">
                       ...
                       <div>
                            ...
                            <div class="mb-3" style="display: flex;">
                                ...
                                <p class="mb-0" style="margin-left: 13px;"><span style="display: block;"> : L453-PTSEL/04/B/PTS/2024/1-G001- BAGI HAKMILIK GM 699 LOT 1044 SELUAS 1.6163 HEKTAR</span>
                            ...
                            <div style="display: flex;">
                                ...
                                <p class="mb-0" style="margin-left: 13px;">: JABATAN PENGAIRAN & SALIRAN SELANGOR</p>
                            </div>
                            
                            <div style="display: flex;">
                                <p class="mb-0" style="min-width: 105px;"><strong>PTJ</strong></p>
                                <p class="mb-0" style="margin-left: 13px;">: PENGARAH PENGAIRAN & SALIRAN</p>
                            </div>
                            
                            <div style="display: flex;">
                                <p style="min-width: 105px;"><strong>Pusat Terimaan </strong></p>
                                <p style="margin-left: 8px;"> : 221000000 - PENGARAH PENGAIRAN & SALIRAN</p>
                            </div>
                        </div>
     ...
     <div class="container pb-5">
        <div class="row mb-5">
           ...
           <!--</div>-->
           <div class="col-md-8">
               <button type="button" class="btn btn-danger float-right px-5">Muat Turun</button>
           </div>
           <div class="col-md-4">
