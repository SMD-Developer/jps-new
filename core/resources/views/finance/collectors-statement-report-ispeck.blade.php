...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Blade variables must be assigned inside `<script>` tags before execution
        const lang = {
            areYouSure: @json(__('app.are_you_sure_finance')),
            confirmationText: @json(__('app.confirmation_text')),
            yes: @json(__('app.yes')),
            no: @json(__('app.no')),
            disclaimerTitle: @json(__('app.email_notifications')),
            disclaimerMessage: `
                 <div style="text-align: left; font-size: 14px; line-height: 1.4;">
                        <p style="margin: 5px 0;">Salam Sejahtera</p>
                        <p style="margin: 5px 0;">Tuan/Puan,</p>
                        <p style="margin: 5px 0;">Sukacita dimaklumkan bahawa fail berikut telah dihantar ke iSPEKS Integration Hub dan sedia untuk dimuat turun.</p>
                        <div style=" padding: 10px 30px; margin: 5px 0;">
                            <p style="margin: 2px 0;"><strong>Nama Fail:</strong> 01_00028_RSP_20240805103323.jpg</p>
                            <p style="margin: 2px 0;"><strong>Tarikh:</strong> 05/08/2024</p>
                            <p style="margin: 2px 0;"><strong>Agensi:</strong> Jabatan Pengairan dan Saliran Negeri Selangor</p>
                        </div>
                        <p style="margin: 10px 0;">Kerjasama tuan/puan adalah dimohon untuk mengambil tindakan selanjutnya.</p>
                        <p style="margin: 5px 0;">Sekian, terima kasih.</p>
                        <p style="margin: 5px 0; font-weight: bold;">Akauntan Negeri/ Bendahari Negeri</p>
                        <hr style="margin: 10px 0;">
                        <p style="margin: 5px 0; font-size: 12px;"><strong>Peringatan:</strong> Ini adalah cetakan komputer. Tiada tandatangan dan maklum balas diperlukan.</p>
                    </div>
            `,
            accept: @json(__('app.continue')),
            cancel: @json(__('app.cancel')),
            sentSuccessfully: @json(__('app.sent_successfully')),
            listOfReceiptSaved: @json(__('app.list_of_receipt_save_successfully'))
        };
        ...
        attachClickEvent('#demo', function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire(lang.listOfReceiptSaved, '', 'success');
                }
            });
        });

        // Demo2 Button Event with Disclaimer
        attachClickEvent('#demo2', function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        title: lang.disclaimerTitle,
                        html: lang.disclaimerMessage,
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
                    ...
                    }).then((disclaimerResult) => {
                        if (disclaimerResult.isConfirmed) {
                            Swal.fire(lang.sentSuccessfully, '', 'success');
                        }
                    });
                }
            });
