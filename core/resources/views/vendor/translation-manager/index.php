...
<div style="width: 80%; margin: auto;">
    ...
    <div class="alert alert-success success-import" style="display:none;">
        <span>Done importing, processed <strong class="counter">N</strong> items! Reload this page to refresh the groups!</span>
    </div>
    <div class="alert alert-success success-find" style="display:none;">
        <span>Done searching for translations, found <strong class="counter">N</strong> items!</span>
    </div>
    <div class="alert alert-success success-publish" style="display:none;">
        <span>Done publishing the translations for group '<?= $group ?>'!</span>
    </div>
